...
namespace Avanpost.Interviews.Task.Integration.SandBox.Tests
{
    public class UnitTest1
    {
        ...
        static string mssqlConnectionString = "Server=localhost;Database=test;User Id=sa;Password=SadSadSadZepino76;TrustServerCertificate=true;";
        static string postgreConnectionString = "Server=localhost;Port=5432;Database=test;Username=postgres;Password=postgres";
